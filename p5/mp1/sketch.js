...
function draw() {
  ...
  if (mouseIsPressed) {
    ...
    fill("#cdf8c6");
    ellipse(590, 165, 250, 250);

    fill("#36C99E");
    quad(481,127,451,267,734,251,718,157);
    fill("#36C99E");
    ellipse(596, 166, 245, 245);
    fill("#31b890");
    ...
    //hair
    fill("#2baf7f");
    quad(595,11,568,14,580,45,594,44);
    fill("#1e7a59");
    quad(568,14,561,23,573,46,580,45);
    ...
    fill("#2baf7f");
    quad(577,17,552,24,580,45,596,45);
    fill("#1e7a59");
    quad(552,24,552,34,574,46,580,45);
